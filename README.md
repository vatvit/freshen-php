<!-- Generated copy of packages/php/README.md from the Freshen monorepo, synced on each release by the shared publish workflow (FRSH-028). Do not edit here. -->
> ⚠️ **Read-only mirror.** This repository is the Packagist publish mirror of
> [`packages/php`](https://github.com/vatvit/freshen/tree/main/packages/php) in the
> [Freshen monorepo](https://github.com/vatvit/freshen). Source, issues, and pull requests
> live there — please don't open them here. Install with `composer require vatvit/freshen-php`.
...
[`COMPATIBILITY.md`](https://github.com/vatvit/freshen/blob/main/COMPATIBILITY.md).
...
> (see [`COMPATIBILITY.md`](https://github.com/vatvit/freshen/blob/main/COMPATIBILITY.md)). Until a stable tag ships,
...
[`docs/PARITY.md`](https://github.com/vatvit/freshen/blob/main/docs/PARITY.md) §12, §14).
...
the cache path. See [`docs/PARITY.md`](https://github.com/vatvit/freshen/blob/main/docs/PARITY.md) §10.
...
returns a `MISS` instead. See [`docs/PARITY.md`](https://github.com/vatvit/freshen/blob/main/docs/PARITY.md) §7.
...
The cross-language behaviour contract is [`docs/PARITY.md`](https://github.com/vatvit/freshen/blob/main/docs/PARITY.md).
...
[MIT](https://github.com/vatvit/freshen/blob/main/LICENSE)
